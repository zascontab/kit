...
func (c *paymentGatewayServiceClient) GetPaymentMethod(ctx context.Context, in *GetPaymentMethodRequest, opts ...grpc.CallOption) (*GetPaymentMethodReply, error) {
	...
	err := c.cc.Invoke(ctx, PaymentGatewayService_GetPaymentMethod_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *stripePaymentGatewayServiceClient) GetStripeConfig(ctx context.Context, in *GetStripeConfigRequest, opts ...grpc.CallOption) (*GetStripeConfigReply, error) {
	...
	err := c.cc.Invoke(ctx, StripePaymentGatewayService_GetStripeConfig_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *stripePaymentGatewayServiceClient) StripeWebhook(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*StripeWebhookReply, error) {
	...
	err := c.cc.Invoke(ctx, StripePaymentGatewayService_StripeWebhook_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// All implementations must embed UnimplementedStripePaymentGatewayServiceServer
// for forward compatibility.
...
// UnimplementedStripePaymentGatewayServiceServer must be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
...
func (UnimplementedStripePaymentGatewayServiceServer) mustEmbedUnimplementedStripePaymentGatewayServiceServer() {
}
func (UnimplementedStripePaymentGatewayServiceServer) testEmbeddedByValue() {}
...
func RegisterStripePaymentGatewayServiceServer(s grpc.ServiceRegistrar, srv StripePaymentGatewayServiceServer) {
	// If the following call pancis, it indicates UnimplementedStripePaymentGatewayServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
