...
const file_user_api_permission_v1_permission_proto_rawDesc = "" +
	"\n" +
	"'user/api/permission/v1/permission.proto\x12\x16user.api.permission.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a google/protobuf/field_mask.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x17validate/validate.proto\"\x1d\n" +
	"\x1bGetCurrentPermissionRequest\"Q\n" +
	"\x19GetCurrentPermissionReply\x124\n" +
	"\x03acl\x18\x01 \x03(\v2\".user.api.permission.v1.PermissionR\x03acl\"\x91\x01\n" +
	"\x16CheckPermissionRequest\x12)\n" +
	"\tnamespace\x18\x01 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\tnamespace\x12'\n" +
	"\bresource\x18\x02 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\bresource\x12#\n" +
	"\x06action\x18\x03 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x06action\"N\n" +
	...
	"\ttenant_id\x18\x06 \x01(\tR\btenantId\"\x8d\x01\n" +
	"\x1eUpdateSubjectPermissionRequest\x12%\n" +
	"\asubject\x18\x01 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\asubject\x12D\n" +
	"\x03acl\x18\x02 \x03(\v22.user.api.permission.v1.UpdateSubjectPermissionAclR\x03acl\"\xf0\x01\n" +
	"\x1aUpdateSubjectPermissionAcl\x12)\n" +
	"\tnamespace\x18\x01 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\tnamespace\x12'\n" +
	"\bresource\x18\x02 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\bresource\x12#\n" +
	"\x06action\x18\x03 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x06action\x12<\n" +
	"\x06effect\x18\x05 \x01(\x0e2\x1e.user.api.permission.v1.EffectB\x04\xe2A\x01\x02R\x06effect\x12\x1b\n" +
	"\ttenant_id\x18\x06 \x01(\tR\btenantId\"W\n" +
	"\x1fUpdateSubjectPermissionResponse\x124\n" +
	"\x03acl\x18\x01 \x03(\v2\".user.api.permission.v1.PermissionR\x03acl\"\xb8\x02\n" +
	...
	"\asubject\x18\x04 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\asubject\x128\n" +
	...
	"\n" +
	"_tenant_id\"\x1e\n" +
	"\x1cRemoveSubjectPermissionReply\"\xa2\x02\n" +
	"\x1bAddSubjectPermissionRequest\x12)\n" +
	"\tnamespace\x18\x01 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\tnamespace\x12'\n" +
	"\bresource\x18\x02 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\bresource\x12#\n" +
	"\x06action\x18\x03 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x06action\x12%\n" +
	"\asubject\x18\x04 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\asubject\x12F\n" +
	"\x06effect\x18\x05 \x01(\x0e2\x1e.user.api.permission.v1.EffectB\x0e\xe2A\x01\x02\xfaB\a\x82\x01\x04\x18\x01\x18\x02R\x06effect\x12\x1b\n" +
	...
	"\x04name\x18\a \x01(\tR\x04name\"\x90\x01\n" +
	"\x15PermissionRequirement\x12)\n" +
	"\tnamespace\x18\x01 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\tnamespace\x12'\n" +
	"\bresource\x18\x02 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\bresource\x12#\n" +
	"\x06action\x18\x03 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x06action*/\n" +
	"\x06Effect\x12\v\n" +
