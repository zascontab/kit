...
const file_user_api_auth_v1_web_proto_rawDesc = "" +
	"\n" +
	"\x1auser/api/auth/v1/web.proto\x12\x10user.api.auth.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x17validate/validate.proto\x1a\x1buser/api/auth/v1/auth.proto\"=\n" +
	...
	"\x11consent_challenge\x18\x01 \x01(\tR\x10consentChallenge\"\xd4\x01\n" +
	"\x12GetConsentResponse\x12)\n" +
	"\tchallenge\x18\x01 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\tchallenge\x12'\n" +
