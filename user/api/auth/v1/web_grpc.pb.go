...
func (c *authWebClient) GetWebLogin(ctx context.Context, in *GetLoginRequest, opts ...grpc.CallOption) (*GetLoginResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthWeb_GetWebLogin_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authWebClient) WebLogin(ctx context.Context, in *WebLoginAuthRequest, opts ...grpc.CallOption) (*WebLoginAuthReply, error) {
	...
	err := c.cc.Invoke(ctx, AuthWeb_WebLogin_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authWebClient) GetWebLogout(ctx context.Context, in *GetLogoutRequest, opts ...grpc.CallOption) (*GetLogoutResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthWeb_GetWebLogout_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authWebClient) WebLogout(ctx context.Context, in *LogoutRequest, opts ...grpc.CallOption) (*LogoutResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthWeb_WebLogout_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authWebClient) GetConsent(ctx context.Context, in *GetConsentRequest, opts ...grpc.CallOption) (*GetConsentResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthWeb_GetConsent_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authWebClient) GrantConsent(ctx context.Context, in *GrantConsentRequest, opts ...grpc.CallOption) (*GrantConsentResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthWeb_GrantConsent_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedAuthWebServer must be embedded to have
...
func (UnimplementedAuthWebServer) testEmbeddedByValue()                 {}
...
func RegisterAuthWebServer(s grpc.ServiceRegistrar, srv AuthWebServer) {
	// If the following call pancis, it indicates UnimplementedAuthWebServer was
