...
const file_user_api_auth_v1_auth_proto_rawDesc = "" +
	"\n" +
	"\x1buser/api/auth/v1/auth.proto\x12\x10user.api.auth.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x17validate/validate.proto\"\xb1\x01\n" +
	"\x13RegisterAuthRequest\x12'\n" +
	"\busername\x18\x01 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\busername\x12'\n" +
	"\bpassword\x18\x05 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\bpassword\x126\n" +
	"\x10confirm_password\x18\x06 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x0fconfirmPassword\x12\x10\n" +
	"\x03web\x18\n" +
	" \x01(\bR\x03web\"\x99\x01\n" +
	"\x11RegisterAuthReply\x12!\n" +
	...
	"\x10LoginAuthRequest\x12'\n" +
	"\busername\x18\x01 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\busername\x12'\n" +
	"\bpassword\x18\x02 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\bpassword\x12\x1a\n" +
	"\bremember\x18\x03 \x01(\bR\bremember\"\xc0\x01\n" +
	"\fTokenRequest\x12S\n" +
	"\n" +
	"grant_type\x18\x01 \x01(\tB4\xfaB1r/R\x00R\bpasswordR\rrefresh_tokenR\x12authorization_codeR\tgrantType\x12\x1a\n" +
	"\busername\x18\x02 \x01(\tR\busername\x12\x1a\n" +
	"\bpassword\x18\x03 \x01(\tR\bpassword\x12#\n" +
	"\rrefresh_token\x18\x04 \x01(\tR\frefreshToken\"\x92\x01\n" +
	"\n" +
	"TokenReply\x12!\n" +
	"\faccess_token\x18\x01 \x01(\tR\vaccessToken\x12\x1d\n" +
	"\n" +
	...
	"\rrefresh_token\x18\x04 \x01(\tR\frefreshToken\x12\x1d\n" +
	"\n" +
	"expires_in\x18\x05 \x01(\x05R\texpiresIn\"\xd0\x01\n" +
	"\x0eLoginAuthReply\x12!\n" +
	"\faccess_token\x18\x01 \x01(\tR\vaccessToken\x12\x1d\n" +
	"\n" +
	"token_type\x18\x02 \x01(\tR\ttokenType\x12\x1c\n" +
	"\aexpires\x18\x03 \x01(\x05B\x02\x18\x01R\aexpires\x12#\n" +
	"\rrefresh_token\x18\x04 \x01(\tR\frefreshToken\x12\x1d\n" +
	"\n" +
	"expires_in\x18\x05 \x01(\x05R\texpiresIn\x12\x1a\n" +
	"\bredirect\x18\n" +
	" \x01(\tR\bredirect\"K\n" +
	"\x17RefreshTokenAuthRequest\x120\n" +
	"\rrefresh_token\x18\x04 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\frefreshToken\"\x9d\x01\n" +
	"\x15RefreshTokenAuthReply\x12!\n" +
	"\faccess_token\x18\x01 \x01(\tR\vaccessToken\x12\x1d\n" +
	"\n" +
	"token_type\x18\x02 \x01(\tR\ttokenType\x12#\n" +
	"\rrefresh_token\x18\x04 \x01(\tR\frefreshToken\x12\x1d\n" +
	"\n" +
	"expires_in\x18\x05 \x01(\x05R\texpiresIn\"\xad\x01\n" +
	"\x1cPasswordlessTokenAuthRequest\x127\n" +
	"\x05phone\x18\x04 \x01(\v2\x1c.google.protobuf.StringValueH\x00R\x05phone\x88\x01\x01\x12@\n" +
	"\x05email\x18\x05 \x01(\v2\x1c.google.protobuf.StringValueB\a\xfaB\x04r\x02`\x01H\x01R\x05email\x88\x01\x01B\b\n" +
	"\x06_phoneB\b\n" +
	"\x06_email\"O\n" +
	"\x1aPasswordlessTokenAuthReply\x121\n" +
	"\x06expire\x18\x01 \x01(\v2\x19.google.protobuf.DurationR\x06expire\"\xd5\x01\n" +
	"\x18LoginPasswordlessRequest\x127\n" +
	"\x05phone\x18\x04 \x01(\v2\x1c.google.protobuf.StringValueH\x00R\x05phone\x88\x01\x01\x127\n" +
	"\x05email\x18\x05 \x01(\v2\x1c.google.protobuf.StringValueH\x01R\x05email\x88\x01\x01\x12!\n" +
	"\x05token\x18\n" +
	" \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x05token\x12\x10\n" +
	"\x03web\x18\x14 \x01(\bR\x03webB\b\n" +
	"\x06_phoneB\b\n" +
	"\x06_email\"\x9e\x01\n" +
	"\x16LoginPasswordlessReply\x12!\n" +
	"\faccess_token\x18\x01 \x01(\tR\vaccessToken\x12\x1d\n" +
	"\n" +
	"token_type\x18\x02 \x01(\tR\ttokenType\x12#\n" +
	"\rrefresh_token\x18\x04 \x01(\tR\frefreshToken\x12\x1d\n" +
	"\n" +
	"expires_in\x18\x05 \x01(\x05R\texpiresIn\"\xa2\x01\n" +
	"\x1aForgetPasswordTokenRequest\x127\n" +
	"\x05phone\x18\x04 \x01(\v2\x1c.google.protobuf.StringValueH\x00R\x05phone\x88\x01\x01\x127\n" +
	"\x05email\x18\x05 \x01(\v2\x1c.google.protobuf.StringValueH\x01R\x05email\x88\x01\x01B\b\n" +
	"\x06_phoneB\b\n" +
	"\x06_email\"M\n" +
	"\x18ForgetPasswordTokenReply\x121\n" +
	"\x06expire\x18\x01 \x01(\v2\x19.google.protobuf.DurationR\x06expire\"\xb3\x01\n" +
	"\x15ForgetPasswordRequest\x127\n" +
	"\x05phone\x18\x04 \x01(\v2\x1c.google.protobuf.StringValueH\x00R\x05phone\x88\x01\x01\x127\n" +
	"\x05email\x18\x05 \x01(\v2\x1c.google.protobuf.StringValueH\x01R\x05email\x88\x01\x01\x12\x14\n" +
	"\x05token\x18\n" +
	" \x01(\tR\x05tokenB\b\n" +
	"\x06_phoneB\b\n" +
	"\x06_email\"I\n" +
	"\x13ForgetPasswordReply\x122\n" +
	"\x15change_password_token\x18\x01 \x01(\tR\x13changePasswordToken\"5\n" +
	"\x17ValidatePasswordRequest\x12\x1a\n" +
	"\bpassword\x18\x01 \x01(\tR\bpassword\"'\n" +
	"\x15ValidatePasswordReply\x12\x0e\n" +
	"\x02ok\x18\x01 \x01(\bR\x02ok\"V\n" +
	"\x0fGetLoginRequest\x12\x1a\n" +
	"\bredirect\x18\x01 \x01(\tR\bredirect\x12'\n" +
	"\x0flogin_challenge\x18\x02 \x01(\tR\x0eloginChallenge\"\x97\x01\n" +
	"\x10GetLoginResponse\x12\x1a\n" +
	"\bredirect\x18\x01 \x01(\tR\bredirect\x125\n" +
	"\x05oauth\x18\x02 \x03(\v2\x1f.user.api.auth.v1.OAuthProviderR\x05oauth\x12\x12\n" +
	"\x04hint\x18\x03 \x01(\tR\x04hint\x12\x1c\n" +
	"\tchallenge\x18\x04 \x01(\tR\tchallenge\"#\n" +
	"\rOAuthProvider\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\"\x15\n" +
	"\x13GetCsrfTokenRequest\"5\n" +
	"\x14GetCsrfTokenResponse\x12\x1d\n" +
	"\n" +
	"csrf_token\x18\x01 \x01(\tR\tcsrfToken\"-\n" +
	"\rLogoutRequest\x12\x1c\n" +
	"\tchallenge\x18\x01 \x01(\tR\tchallenge\",\n" +
	"\x0eLogoutResponse\x12\x1a\n" +
	"\bredirect\x18\x01 \x01(\tR\bredirect\"\xb9\x01\n" +
	"\x13WebLoginAuthRequest\x12'\n" +
	"\busername\x18\x01 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\busername\x12'\n" +
	"\bpassword\x18\x02 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\bpassword\x12\x1a\n" +
	"\bremember\x18\x03 \x01(\bR\bremember\x12\x1c\n" +
	"\tchallenge\x18\x04 \x01(\tR\tchallenge\x12\x16\n" +
	"\x06reject\x18\x05 \x01(\bR\x06reject\"\xcf\x01\n" +
	"\x11WebLoginAuthReply\x12!\n" +
	"\faccess_token\x18\x01 \x01(\tR\vaccessToken\x12\x1d\n" +
	"\n" +
	"token_type\x18\x02 \x01(\tR\ttokenType\x12\x18\n" +
	"\aexpires\x18\x03 \x01(\x05R\aexpires\x12#\n" +
	"\rrefresh_token\x18\x04 \x01(\tR\frefreshToken\x12\x1d\n" +
	"\n" +
	"expires_in\x18\x05 \x01(\x05R\texpiresIn\x12\x1a\n" +
	"\bredirect\x18\n" +
	" \x01(\tR\bredirect\"\xcf\x01\n" +
	"\x1dChangePasswordByForgetRequest\x12?\n" +
	"\x15change_password_token\x18\x01 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x13changePasswordToken\x12.\n" +
	"\fnew_password\x18\x05 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\vnewPassword\x12=\n" +
	"\x14confirm_new_password\x18\x06 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x12confirmNewPassword\"\x1d\n" +
	"\x1bChangePasswordByForgetReply\"\xbb\x01\n" +
	"\x1aChangePasswordByPreRequest\x12.\n" +
	"\fpre_password\x18\x04 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\vprePassword\x12.\n" +
	"\fnew_password\x18\x05 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\vnewPassword\x12=\n" +
	"\x14confirm_new_password\x18\x06 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x12confirmNewPassword\"\x1a\n" +
	"\x18ChangePasswordByPreReply\"8\n" +
	"\x1bRefreshRememberTokenRequest\x12\x19\n" +
	"\brm_token\x18\x01 \x01(\tR\armToken\"V\n" +
	"\x19RefreshRememberTokenReply\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12 \n" +
	"\fnew_rm_token\x18\x02 \x01(\tR\n" +
	"newRmToken2\xbf\x0e\n" +
	"\x04Auth\x12t\n" +
	"\bRegister\x12%.user.api.auth.v1.RegisterAuthRequest\x1a#.user.api.auth.v1.RegisterAuthReply\"\x1c\x82\xd3\xe4\x93\x02\x16:\x01*\"\x11/v1/auth/register\x12h\n" +
	"\x05Login\x12\".user.api.auth.v1.LoginAuthRequest\x1a .user.api.auth.v1.LoginAuthReply\"\x19\x82\xd3\xe4\x93\x02\x13:\x01*\"\x0e/v1/auth/login\x12i\n" +
	"\bGetLogin\x12!.user.api.auth.v1.GetLoginRequest\x1a\".user.api.auth.v1.GetLoginResponse\"\x16\x82\xd3\xe4\x93\x02\x10\x12\x0e/v1/auth/login\x12`\n" +
	"\x05Token\x12\x1e.user.api.auth.v1.TokenRequest\x1a\x1c.user.api.auth.v1.TokenReply\"\x19\x82\xd3\xe4\x93\x02\x13:\x01*\"\x0e/v1/auth/token\x12z\n" +
	"\aRefresh\x12).user.api.auth.v1.RefreshTokenAuthRequest\x1a'.user.api.auth.v1.RefreshTokenAuthReply\"\x1b\x82\xd3\xe4\x93\x02\x15:\x01*\"\x10/v1/auth/refresh\x12\x9e\x01\n" +
	"\x15SendPasswordlessToken\x12..user.api.auth.v1.PasswordlessTokenAuthRequest\x1a,.user.api.auth.v1.PasswordlessTokenAuthReply\"'\x82\xd3\xe4\x93\x02!:\x01*\"\x1c/v1/auth/action/passwordless\x12\x91\x01\n" +
	"\x11LoginPasswordless\x12*.user.api.auth.v1.LoginPasswordlessRequest\x1a(.user.api.auth.v1.LoginPasswordlessReply\"&\x82\xd3\xe4\x93\x02 :\x01*\"\x1b/v1/auth/login/passwordless\x12\x96\x01\n" +
	"\x17SendForgetPasswordToken\x12,.user.api.auth.v1.ForgetPasswordTokenRequest\x1a*.user.api.auth.v1.ForgetPasswordTokenReply\"!\x82\xd3\xe4\x93\x02\x1b:\x01*\"\x16/v1/auth/action/forget\x12\x85\x01\n" +
	"\x0eForgetPassword\x12'.user.api.auth.v1.ForgetPasswordRequest\x1a%.user.api.auth.v1.ForgetPasswordReply\"#\x82\xd3\xe4\x93\x02\x1d:\x01*\"\x18/v1/auth/password/forget\x12\xa4\x01\n" +
	"\x16ChangePasswordByForget\x12/.user.api.auth.v1.ChangePasswordByForgetRequest\x1a-.user.api.auth.v1.ChangePasswordByForgetReply\"*\x82\xd3\xe4\x93\x02$:\x01*\"\x1f/v1/auth/password/forget/change\x12\x8d\x01\n" +
	"\x10ValidatePassword\x12).user.api.auth.v1.ValidatePasswordRequest\x1a'.user.api.auth.v1.ValidatePasswordReply\"%\x82\xd3\xe4\x93\x02\x1f:\x01*\"\x1a/v1/auth/password/validate\x12\x94\x01\n" +
	"\x13ChangePasswordByPre\x12,.user.api.auth.v1.ChangePasswordByPreRequest\x1a*.user.api.auth.v1.ChangePasswordByPreReply\"#\x82\xd3\xe4\x93\x02\x1d:\x01*\"\x18/v1/auth/password/change\x12t\n" +
	"\fGetCsrfToken\x12%.user.api.auth.v1.GetCsrfTokenRequest\x1a&.user.api.auth.v1.GetCsrfTokenResponse\"\x15\x82\xd3\xe4\x93\x02\x0f\x12\r/v1/auth/csrf\x12t\n" +
	"\x14RefreshRememberToken\x12-.user.api.auth.v1.RefreshRememberTokenRequest\x1a+.user.api.auth.v1.RefreshRememberTokenReply\"\x00B,Z*github.com/go-saas/kit/user/api/auth/v1;v1b\x06proto3"

var (
	file_user_api_auth_v1_auth_proto_rawDescOnce sync.Once
	file_user_api_auth_v1_auth_proto_rawDescData []byte
)

func file_user_api_auth_v1_auth_proto_rawDescGZIP() []byte {
	file_user_api_auth_v1_auth_proto_rawDescOnce.Do(func() {
		file_user_api_auth_v1_auth_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_user_api_auth_v1_auth_proto_rawDesc), len(file_user_api_auth_v1_auth_proto_rawDesc)))
	})
...
var file_user_api_auth_v1_auth_proto_goTypes = []any{
...
func file_user_api_auth_v1_auth_proto_init() {
	...
	file_user_api_auth_v1_auth_proto_msgTypes[8].OneofWrappers = []any{}
	file_user_api_auth_v1_auth_proto_msgTypes[10].OneofWrappers = []any{}
	file_user_api_auth_v1_auth_proto_msgTypes[12].OneofWrappers = []any{}
	file_user_api_auth_v1_auth_proto_msgTypes[14].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_user_api_auth_v1_auth_proto_rawDesc), len(file_user_api_auth_v1_auth_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   33,
			NumExtensions: 0,
			NumServices:   1,
