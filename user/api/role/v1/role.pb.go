...
const file_user_api_role_v1_role_proto_rawDesc = "" +
	"\n" +
	"\x1buser/api/role/v1/role.proto\x12\x10user.api.role.v1\x1a\x1cgoogle/api/annotations.proto\x1a google/protobuf/field_mask.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a'user/api/permission/v1/permission.proto\x1a\x17validate/validate.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x15query/operation.proto\"\x80\x01\n" +
	"\n" +
	"RoleFilter\x126\n" +
	...
	"\x04name\x18\x02 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x04name\"\x90\x01\n" +
	"\x11UpdateRoleRequest\x12>\n" +
	"\x04role\x18\x02 \x01(\v2\x1c.user.api.role.v1.UpdateRoleB\f\xe2A\x01\x02\xfaB\x05\x8a\x01\x02\x10\x01R\x04role\x12;\n" +
	"\vupdate_mask\x18\x03 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\"\x87\x01\n" +
	"\n" +
	"UpdateRole\x12\x1b\n" +
	"\x02id\x18\x01 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x02id\x12\x1f\n" +
	"\x04name\x18\x02 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x04name\x12;\n" +
	"\x03acl\x18\x03 \x03(\v2).user.api.role.v1.UpdateRolePermissionAclR\x03acl\"0\n" +
	"\x11DeleteRoleRequest\x12\x1b\n" +
	"\x02id\x18\x01 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x02id\"\x14\n" +
	"\x12DeleteRoleResponse\"7\n" +
	"\x18GetRolePermissionRequest\x12\x1b\n" +
	"\x02id\x18\x01 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x02id\"\x9c\x01\n" +
	"\x19GetRolePermissionResponse\x124\n" +
	"\x03acl\x18\x01 \x03(\v2\".user.api.permission.v1.PermissionR\x03acl\x12I\n" +
	"\n" +
	"def_groups\x18\x02 \x03(\v2*.user.api.permission.v1.PermissionDefGroupR\tdefGroups\"w\n" +
	"\x1bUpdateRolePermissionRequest\x12\x1b\n" +
	"\x02id\x18\x01 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x02id\x12;\n" +
