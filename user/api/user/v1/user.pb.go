...
const file_user_api_user_v1_user_proto_rawDesc = "" +
	"\n" +
	"\x1buser/api/user/v1/user.proto\x12\x10user.api.user.v1\x1a\x1cgoogle/api/annotations.proto\x1a google/protobuf/field_mask.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\x1a\x17validate/validate.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1buser/api/role/v1/role.proto\x1a\x0fblob/blob.proto\x1a\x15query/operation.proto\x1a'user/api/permission/v1/permission.proto\"\xd8\x02\n" +
	"\n" +
	"UserFilter\x126\n" +
	"\x02id\x18\x01 \x01(\v2&.query.operation.StringFilterOperationR\x02id\x12>\n" +
	"\x06gender\x18\x02 \x01(\v2&.query.operation.StringFilterOperationR\x06gender\x12@\n" +
	"\bbirthday\x18\x03 \x01(\v2$.query.operation.DateFilterOperatorsR\bbirthday\x122\n" +
	"\x05roles\x18\x05 \x01(\v2\x1c.user.api.role.v1.RoleFilterR\x05roles\x12.\n" +
	"\x03and\x18\a \x03(\v2\x1c.user.api.user.v1.UserFilterR\x03and\x12,\n" +
	"\x02or\x18\b \x03(\v2\x1c.user.api.user.v1.UserFilterR\x02or\"\xe6\x01\n" +
	...
	"\x06filter\x18\x06 \x01(\v2\x1c.user.api.user.v1.UserFilterR\x06filter\"-\n" +
	"\x0eGetUserRequest\x12\x1b\n" +
	"\x02id\x18\x01 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x02id\"\x82\x03\n" +
	"\x04User\x12\x0e\n" +
	...
	"\x05roles\x18\b \x03(\v2\x16.user.api.role.v1.RoleR\x05roles\x12&\n" +
	"\x06avatar\x18\n" +
	" \x01(\v2\x0e.blob.BlobFileR\x06avatarB\v\n" +
	"\t_usernameB\a\n" +
	"\x05_nameB\b\n" +
	"\x06_phoneB\b\n" +
	"\x06_emailB\v\n" +
	...
	"filterSize\x12,\n" +
	"\x05items\x18\x03 \x03(\v2\x16.user.api.user.v1.UserR\x05items\"\xbc\x03\n" +
	...
	"\x05email\x18\x04 \x01(\tB\a\xfaB\x04r\x02`\x01H\x03R\x05email\x88\x01\x01\x12\x1a\n" +
	...
	"\x06avatar\x18\t \x01(\tR\x06avatar\x12\x19\n" +
	"\broles_id\x18\n" +
	" \x03(\tR\arolesId\x12\x0e\n" +
	"\x02id\x18\v \x01(\tR\x02idB\v\n" +
	"\t_usernameB\a\n" +
	"\x05_nameB\b\n" +
	"\x06_phoneB\b\n" +
	"\x06_emailB\v\n" +
	...
	"\x04user\x18\x02 \x01(\v2\x1c.user.api.user.v1.UpdateUserB\f\xe2A\x01\x02\xfaB\x05\x8a\x01\x02\x10\x01R\x04user\x12;\n" +
	"\vupdate_mask\x18\x03 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\"D\n" +
	"\n" +
	"UpdateUser\x12\x1b\n" +
	"\x02id\x18\x01 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x02id\x12\x19\n" +
	"\broles_id\x18\v \x03(\tR\arolesId\"#\n" +
	"\x11DeleteUserRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\"\x14\n" +
	"\x12DeleteUserResponse\"$\n" +
	"\x12GetUserRoleRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\"D\n" +
	"\x10GetUserRoleReply\x120\n" +
	"\x05roles\x18\x01 \x03(\v2\x1a.user.api.user.v1.UserRoleR\x05roles\".\n" +
	"\bUserRole\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\"<\n" +
	"\x11InviteUserRequest\x12'\n" +
	"\bidentify\x18\x01 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\bidentify\"<\n" +
	"\x0fInviteUserReply\x12)\n" +
	"\x10required_confirm\x18\x01 \x01(\bR\x0frequiredConfirm\"N\n" +
	"\x16CheckUserTenantRequest\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12\x1b\n" +
	"\ttenant_id\x18\x02 \x01(\tR\btenantId\"&\n" +
	"\x14CheckUserTenantReply\x12\x0e\n" +
	"\x02ok\x18\x01 \x01(\bR\x02ok\"7\n" +
	"\x18GetUserPermissionRequest\x12\x1b\n" +
	"\x02id\x18\x01 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x02id\"\x99\x01\n" +
	"\x16GetUserPermissionReply\x124\n" +
	"\x03acl\x18\x01 \x03(\v2\".user.api.permission.v1.PermissionR\x03acl\x12I\n" +
	"\n" +
	"def_groups\x18\x02 \x03(\v2*.user.api.permission.v1.PermissionDefGroupR\tdefGroups\"\x80\x01\n" +
	"\x1bUpdateUserPermissionRequest\x12\x1b\n" +
	"\x02id\x18\x01 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x02id\x12D\n" +
	"\x03acl\x18\x02 \x03(\v22.user.api.permission.v1.UpdateSubjectPermissionAclR\x03acl\"\x1b\n" +
	"\x19UpdateUserPermissionReply\"\xf6\x01\n" +
	"\x11SearchUserRequest\x12\x1f\n" +
	"\bidentity\x18\x01 \x01(\tH\x00R\bidentity\x88\x01\x01\x12\x1f\n" +
	...
	"\x05phone\x18\x05 \x01(\tH\x03R\x05phone\x88\x01\x01\x122\n" +
	"\x06fields\x18\n" +
	" \x01(\v2\x1a.google.protobuf.FieldMaskR\x06fieldsB\v\n" +
	"\t_identityB\v\n" +
	"\t_usernameB\b\n" +
	"\x06_emailB\b\n" +
	"\x06_phone\"\xcd\x01\n" +
	"\x12SearchUserResponse\x12C\n" +
	"\x04user\x18\x01 \x01(\v2/.user.api.user.v1.SearchUserResponse.SearchUserR\x04user\x1ar\n" +
	"\n" +
	"SearchUser\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1f\n" +
	...
	" \x01(\v2\x0e.blob.BlobFileR\x06avatarB\v\n" +
	"\t_username\"\xb6\x02\n" +
	"\x1fUserInternalCreateTenantRequest\x12\x1b\n" +
	"\ttenant_id\x18\x01 \x01(\tR\btenantId\x12-\n" +
	"\vadmin_email\x18\a \x01(\tB\a\xfaB\x04r\x02`\x01H\x00R\n" +
	"adminEmail\x88\x01\x01\x12*\n" +
	"\x0eadmin_username\x18\b \x01(\tH\x01R\radminUsername\x88\x01\x01\x12*\n" +
	"\x0eadmin_password\x18\t \x01(\tH\x02R\radminPassword\x88\x01\x01\x12'\n" +
	"\radmin_user_id\x18\n" +
	" \x01(\tH\x03R\vadminUserId\x88\x01\x01B\x0e\n" +
	"\f_admin_emailB\x11\n" +
	"\x0f_admin_usernameB\x11\n" +
	"\x0f_admin_passwordB\x10\n" +
	"\x0e_admin_user_id\"\x97\x01\n" +
	"!FindOrCreateStripeCustomerRequest\x12\x1c\n" +
	"\auser_id\x18\x01 \x01(\tH\x00R\x06userId\x88\x01\x01\x121\n" +
	"\x12stripe_customer_id\x18\x02 \x01(\tH\x01R\x10stripeCustomerId\x88\x01\x01B\n" +
	"\n" +
	"\b_user_idB\x15\n" +
	"\x13_stripe_customer_id\"{\n" +
	"\x1fFindOrCreateStripeCustomerReply\x12*\n" +
	"\x04user\x18\x01 \x01(\v2\x16.user.api.user.v1.UserR\x04user\x12,\n" +
	"\x12stripe_customer_id\x18\x02 \x01(\tR\x10stripeCustomerId*6\n" +
	"\x06Gender\x12\v\n" +
	"\aUNKNOWN\x10\x00\x12\b\n" +
	"\x04MALE\x10\x01\x12\n" +
	"\n" +
	"\x06FEMALE\x10\x02\x12\t\n" +
	"\x05OTHER\x10\x032\xd1\t\n" +
	"\vUserService\x12{\n" +
	"\tListUsers\x12\".user.api.user.v1.ListUsersRequest\x1a#.user.api.user.v1.ListUsersResponse\"%\x82\xd3\xe4\x93\x02\x1fZ\x12:\x01*\"\r/v1/user/list\x12\t/v1/users\x12Z\n" +
	"\aGetUser\x12 .user.api.user.v1.GetUserRequest\x1a\x16.user.api.user.v1.User\"\x15\x82\xd3\xe4\x93\x02\x0f\x12\r/v1/user/{id}\x12^\n" +
	"\n" +
	"CreateUser\x12#.user.api.user.v1.CreateUserRequest\x1a\x16.user.api.user.v1.User\"\x13\x82\xd3\xe4\x93\x02\r:\x01*\"\b/v1/user\x12\x81\x01\n" +
	"\n" +
	"UpdateUser\x12#.user.api.user.v1.UpdateUserRequest\x1a\x16.user.api.user.v1.User\"6\x82\xd3\xe4\x93\x020:\x01*Z\x17:\x01*2\x12/v1/user/{user.id}\x1a\x12/v1/user/{user.id}\x12n\n" +
	"\n" +
	"DeleteUser\x12#.user.api.user.v1.DeleteUserRequest\x1a$.user.api.user.v1.DeleteUserResponse\"\x15\x82\xd3\xe4\x93\x02\x0f*\r/v1/user/{id}\x12u\n" +
	"\fGetUserRoles\x12$.user.api.user.v1.GetUserRoleRequest\x1a\".user.api.user.v1.GetUserRoleReply\"\x1b\x82\xd3\xe4\x93\x02\x15\x12\x13/v1/user/{id}/roles\x12\x8b\x01\n" +
	"\x11GetUserPermission\x12*.user.api.user.v1.GetUserPermissionRequest\x1a(.user.api.user.v1.GetUserPermissionReply\" \x82\xd3\xe4\x93\x02\x1a\x12\x18/v1/user/{id}/permission\x12\x97\x01\n" +
	"\x14UpdateUserPermission\x12-.user.api.user.v1.UpdateUserPermissionRequest\x1a+.user.api.user.v1.UpdateUserPermissionReply\"#\x82\xd3\xe4\x93\x02\x1d:\x01*\x1a\x18/v1/user/{id}/permission\x12w\n" +
	"\n" +
	"InviteUser\x12#.user.api.user.v1.InviteUserRequest\x1a!.user.api.user.v1.InviteUserReply\"!\x82\xd3\xe4\x93\x02\x1b:\x01*\"\x16/v1/user/public/invite\x12}\n" +
	"\x10PublicSearchUser\x12#.user.api.user.v1.SearchUserRequest\x1a$.user.api.user.v1.SearchUserResponse\"\x1e\x82\xd3\xe4\x93\x02\x18\x12\x16/v1/user/public/search2\xe2\x02\n" +
	"\x13UserInternalService\x12[\n" +
	"\fCreateTenant\x121.user.api.user.v1.UserInternalCreateTenantRequest\x1a\x16.google.protobuf.Empty\"\x00\x12e\n" +
	"\x0fCheckUserTenant\x12(.user.api.user.v1.CheckUserTenantRequest\x1a&.user.api.user.v1.CheckUserTenantReply\"\x00\x12\x86\x01\n" +
	"\x1aFindOrCreateStripeCustomer\x123.user.api.user.v1.FindOrCreateStripeCustomerRequest\x1a1.user.api.user.v1.FindOrCreateStripeCustomerReply\"\x00B\xad\x01\x92A~\x12\x13\n" +
	"\fUser Service2\x031.0ZY\n" +
	"W\n" +
	"\x06bearer\x12M\b\x02\x128Authentication token, prefixed by Bearer: Bearer <token>\x1a\rAuthorization \x02b\f\n" +
	"\n" +
	"\n" +
	"\x06bearer\x12\x00Z*github.com/go-saas/kit/user/api/user/v1;v1b\x06proto3"

var (
	file_user_api_user_v1_user_proto_rawDescOnce sync.Once
	file_user_api_user_v1_user_proto_rawDescData []byte
)

func file_user_api_user_v1_user_proto_rawDescGZIP() []byte {
	file_user_api_user_v1_user_proto_rawDescOnce.Do(func() {
		file_user_api_user_v1_user_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_user_api_user_v1_user_proto_rawDesc), len(file_user_api_user_v1_user_proto_rawDesc)))
	})
...
var file_user_api_user_v1_user_proto_goTypes = []any{
...
func file_user_api_user_v1_user_proto_init() {
	...
	file_user_api_user_v1_user_proto_msgTypes[3].OneofWrappers = []any{}
	file_user_api_user_v1_user_proto_msgTypes[5].OneofWrappers = []any{}
	file_user_api_user_v1_user_proto_msgTypes[21].OneofWrappers = []any{}
	file_user_api_user_v1_user_proto_msgTypes[23].OneofWrappers = []any{}
	file_user_api_user_v1_user_proto_msgTypes[24].OneofWrappers = []any{}
	file_user_api_user_v1_user_proto_msgTypes[26].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_user_api_user_v1_user_proto_rawDesc), len(file_user_api_user_v1_user_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   27,
			NumExtensions: 0,
			NumServices:   2,
