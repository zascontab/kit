...
// All implementations must embed UnimplementedMyOrderServiceServer
// for forward compatibility.
...
// UnimplementedMyOrderServiceServer must be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
...
func (UnimplementedMyOrderServiceServer) mustEmbedUnimplementedMyOrderServiceServer() {}
