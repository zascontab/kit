...
const file_saas_api_tenant_v1_tenant_proto_rawDesc = "" +
	"\n" +
	"\x1fsaas/api/tenant/v1/tenant.proto\x12\x12saas.api.tenant.v1\x1a\x1cgoogle/api/annotations.proto\x1a google/protobuf/field_mask.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x17validate/validate.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\x1a\x0fblob/blob.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x15query/operation.proto\x1a\x0fdata/data.proto\x1a\x1bsaas/api/plan/v1/plan.proto\"\xd0\x03\n" +
	"\x13CreateTenantRequest\x12Q\n" +
	"\x04name\x18\x02 \x01(\tB=\xe2A\x01\x02\xfaB6r4\x10\x0120^[A-Za-z0-9](?:[A-Za-z0-9\\-]{1,61}[A-Za-z0-9])?$R\x04name\x12!\n" +
	"\fdisplay_name\x18\x03 \x01(\tR\vdisplayName\x12\x16\n" +
	"\x06region\x18\x04 \x01(\tR\x06region\x12\x12\n" +
	"\x04logo\x18\x05 \x01(\tR\x04logo\x12\x1f\n" +
	...
	"\x0e_admin_user_id\"\x9a\x01\n" +
	"\x13UpdateTenantRequest\x12F\n" +
	"\x06tenant\x18\x01 \x01(\v2 .saas.api.tenant.v1.UpdateTenantB\f\xe2A\x01\x02\xfaB\x05\x8a\x01\x02\x10\x01R\x06tenant\x12;\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\"\xb4\x02\n" +
	"\fUpdateTenant\x12\x1b\n" +
	"\x02id\x18\x01 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x02id\x12Q\n" +
	"\x04name\x18\x02 \x01(\tB=\xe2A\x01\x02\xfaB6r4\x10\x0120^[A-Za-z0-9](?:[A-Za-z0-9\\-]{1,61}[A-Za-z0-9])?$R\x04name\x12!\n" +
	"\fdisplay_name\x18\x03 \x01(\tR\vdisplayName\x12>\n" +
	"\x04conn\x18\a \x03(\v2*.saas.api.tenant.v1.TenantConnectionStringR\x04conn\x12=\n" +
	"\bfeatures\x18\b \x03(\v2!.saas.api.tenant.v1.TenantFeatureR\bfeatures\x12\x12\n" +
	"\x04logo\x18\t \x01(\tR\x04logo\"%\n" +
	"\x13DeleteTenantRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\"#\n" +
	"\x11DeleteTenantReply\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\"0\n" +
	"\x10GetTenantRequest\x12\x1c\n" +
	"\n" +
	"id_or_name\x18\x01 \x01(\tR\bidOrName\"6\n" +
	"\x16GetTenantPublicRequest\x12\x1c\n" +
	"\n" +
	"id_or_name\x18\x01 \x01(\tR\bidOrName\"\xc2\x01\n" +
	"\fTenantFilter\x126\n" +
	...
	"\x06region\x18\x04 \x01(\v2&.query.operation.StringFilterOperationR\x06region\"\xeb\x01\n" +
	"\x11ListTenantRequest\x12\x1f\n" +
	"\vpage_offset\x18\x01 \x01(\x05R\n" +
	"pageOffset\x12\x1b\n" +
	"\tpage_size\x18\x02 \x01(\x05R\bpageSize\x12\x16\n" +
	"\x06search\x18\x03 \x01(\tR\x06search\x12\x12\n" +
	"\x04sort\x18\x04 \x03(\tR\x04sort\x122\n" +
	"\x06fields\x18\x05 \x01(\v2\x1a.google.protobuf.FieldMaskR\x06fields\x128\n" +
	"\x06filter\x18\x06 \x01(\v2 .saas.api.tenant.v1.TenantFilterR\x06filter\"\x83\x01\n" +
	"\x0fListTenantReply\x12\x1d\n" +
	"\n" +
	"total_size\x18\x01 \x01(\x05R\ttotalSize\x12\x1f\n" +
	"\vfilter_size\x18\x02 \x01(\x05R\n" +
	"filterSize\x120\n" +
	"\x05items\x18\x03 \x03(\v2\x1a.saas.api.tenant.v1.TenantR\x05items\"\xb6\x04\n" +
	"\x06Tenant\x12\x0e\n" +
	...
	"\x04conn\x18\a \x03(\v2*.saas.api.tenant.v1.TenantConnectionStringR\x04conn\x12=\n" +
	"\bfeatures\x18\b \x03(\v2!.saas.api.tenant.v1.TenantFeatureR\bfeatures\x12\"\n" +
	"\x04logo\x18\t \x01(\v2\x0e.blob.BlobFileR\x04logo\x12\x1f\n" +
	"\vseparate_db\x18\n" +
	" \x01(\bR\n" +
	"separateDb\x12\x12\n" +
	"\x04host\x18\v \x01(\tR\x04host\x12\x1e\n" +
	"\bplan_key\x18\x14 \x01(\tH\x02R\aplanKey\x88\x01\x01\x12*\n" +
	"\x04plan\x18\x15 \x01(\v2\x16.saas.api.plan.v1.PlanR\x04planB\r\n" +
	"\v_created_atB\r\n" +
	"\v_updated_atB\v\n" +
	"\t_plan_key\"@\n" +
	"\x16TenantConnectionString\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value\"K\n" +
	"\rTenantFeature\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12(\n" +
	"\x05value\x18\x02 \x01(\v2\x12.data.DynamicValueR\x05value\"\xfc\x01\n" +
	"\n" +
	"TenantInfo\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12!\n" +
	"\fdisplay_name\x18\x03 \x01(\tR\vdisplayName\x12\x16\n" +
	"\x06region\x18\x04 \x01(\tR\x06region\x12\"\n" +
	"\x04logo\x18\t \x01(\v2\x0e.blob.BlobFileR\x04logo\x12\x12\n" +
	"\x04host\x18\n" +
	" \x01(\tR\x04host\x12\x1e\n" +
	"\bplan_key\x18\x14 \x01(\tH\x00R\aplanKey\x88\x01\x01\x12*\n" +
	"\x04plan\x18\x15 \x01(\v2\x16.saas.api.plan.v1.PlanR\x04planB\v\n" +
	"\t_plan_key\"\x19\n" +
	"\x17GetCurrentTenantRequest\"h\n" +
	"\x15GetCurrentTenantReply\x126\n" +
	"\x06tenant\x18\x01 \x01(\v2\x1e.saas.api.tenant.v1.TenantInfoR\x06tenant\x12\x17\n" +
	"\ais_host\x18\x02 \x01(\bR\x06isHost\"3\n" +
	"\x13ChangeTenantRequest\x12\x1c\n" +
	"\n" +
	"id_or_name\x18\x01 \x01(\tR\bidOrName\"d\n" +
	"\x11ChangeTenantReply\x126\n" +
	"\x06tenant\x18\x01 \x01(\v2\x1e.saas.api.tenant.v1.TenantInfoR\x06tenant\x12\x17\n" +
	"\ais_host\x18\x02 \x01(\bR\x06isHost\"\xbb\x01\n" +
	"\x17UserCreateTenantRequest\x12Q\n" +
	"\x04name\x18\x02 \x01(\tB=\xe2A\x01\x02\xfaB6r4\x10\x0120^[A-Za-z0-9](?:[A-Za-z0-9\\-]{1,61}[A-Za-z0-9])?$R\x04name\x12!\n" +
	"\fdisplay_name\x18\x03 \x01(\tR\vdisplayName\x12\x16\n" +
	"\x06region\x18\x04 \x01(\tR\x06region\x12\x12\n" +
	"\x04logo\x18\x05 \x01(\tR\x04logo\"K\n" +
	"\x15UserCreateTenantReply\x122\n" +
	"\x06tenant\x18\x01 \x01(\v2\x1a.saas.api.tenant.v1.TenantR\x06tenant2\xd6\t\n" +
	"\rTenantService\x12o\n" +
	"\fCreateTenant\x12'.saas.api.tenant.v1.CreateTenantRequest\x1a\x1a.saas.api.tenant.v1.Tenant\"\x1a\x82\xd3\xe4\x93\x02\x14:\x01*\"\x0f/v1/saas/tenant\x12\x9d\x01\n" +
	"\fUpdateTenant\x12'.saas.api.tenant.v1.UpdateTenantRequest\x1a\x1a.saas.api.tenant.v1.Tenant\"H\x82\xd3\xe4\x93\x02B:\x01*Z :\x01*2\x1b/v1/saas/tenant/{tenant.id}\x1a\x1b/v1/saas/tenant/{tenant.id}\x12|\n" +
	"\fDeleteTenant\x12'.saas.api.tenant.v1.DeleteTenantRequest\x1a%.saas.api.tenant.v1.DeleteTenantReply\"\x1c\x82\xd3\xe4\x93\x02\x16*\x14/v1/saas/tenant/{id}\x12s\n" +
	"\tGetTenant\x12$.saas.api.tenant.v1.GetTenantRequest\x1a\x1a.saas.api.tenant.v1.Tenant\"$\x82\xd3\xe4\x93\x02\x1e\x12\x1c/v1/saas/tenant/{id_or_name}\x12\x8a\x01\n" +
	"\x0fGetTenantPublic\x12*.saas.api.tenant.v1.GetTenantPublicRequest\x1a\x1e.saas.api.tenant.v1.TenantInfo\"+\x82\xd3\xe4\x93\x02%\x12#/v1/saas/tenant/{id_or_name}/public\x12\x8d\x01\n" +
	"\n" +
	"ListTenant\x12%.saas.api.tenant.v1.ListTenantRequest\x1a#.saas.api.tenant.v1.ListTenantReply\"3\x82\xd3\xe4\x93\x02-Z\x19:\x01*\"\x14/v1/saas/tenant/list\x12\x10/v1/saas/tenants\x12\x84\x01\n" +
	"\x10GetCurrentTenant\x12+.saas.api.tenant.v1.GetCurrentTenantRequest\x1a).saas.api.tenant.v1.GetCurrentTenantReply\"\x18\x82\xd3\xe4\x93\x02\x12\x12\x10/v1/saas/current\x12\x8e\x01\n" +
	"\fChangeTenant\x12'.saas.api.tenant.v1.ChangeTenantRequest\x1a%.saas.api.tenant.v1.ChangeTenantReply\".\x82\xd3\xe4\x93\x02(:\x01*\"#/v1/saas/change-tenant/{id_or_name}\x12\x8b\x01\n" +
	"\x10UserCreateTenant\x12+.saas.api.tenant.v1.UserCreateTenantRequest\x1a).saas.api.tenant.v1.UserCreateTenantReply\"\x1f\x82\xd3\xe4\x93\x02\x19:\x01*\"\x14/v1/saas/user/tenant2\xc4\x01\n" +
	"\x15TenantInternalService\x12O\n" +
	"\tGetTenant\x12$.saas.api.tenant.v1.GetTenantRequest\x1a\x1a.saas.api.tenant.v1.Tenant\"\x00\x12Z\n" +
	"\n" +
	"ListTenant\x12%.saas.api.tenant.v1.ListTenantRequest\x1a#.saas.api.tenant.v1.ListTenantReply\"\x00B\xaf\x01\x92A~\x12\x13\n" +
	"\fSaas Service2\x031.0ZY\n" +
	"W\n" +
	"\x06bearer\x12M\b\x02\x128Authentication token, prefixed by Bearer: Bearer <token>\x1a\rAuthorization \x02b\f\n" +
	"\n" +
	"\n" +
	"\x06bearer\x12\x00Z,github.com/go-saas/kit/saas/api/tenant/v1;v1b\x06proto3"

var (
	file_saas_api_tenant_v1_tenant_proto_rawDescOnce sync.Once
	file_saas_api_tenant_v1_tenant_proto_rawDescData []byte
)

func file_saas_api_tenant_v1_tenant_proto_rawDescGZIP() []byte {
	file_saas_api_tenant_v1_tenant_proto_rawDescOnce.Do(func() {
		file_saas_api_tenant_v1_tenant_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_saas_api_tenant_v1_tenant_proto_rawDesc), len(file_saas_api_tenant_v1_tenant_proto_rawDesc)))
	})
...
var file_saas_api_tenant_v1_tenant_proto_goTypes = []any{
...
func file_saas_api_tenant_v1_tenant_proto_init() {
	...
	file_saas_api_tenant_v1_tenant_proto_msgTypes[0].OneofWrappers = []any{}
	file_saas_api_tenant_v1_tenant_proto_msgTypes[10].OneofWrappers = []any{}
	file_saas_api_tenant_v1_tenant_proto_msgTypes[13].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_saas_api_tenant_v1_tenant_proto_rawDesc), len(file_saas_api_tenant_v1_tenant_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   20,
			NumExtensions: 0,
			NumServices:   2,
