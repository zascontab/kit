...
const file_saas_api_plan_v1_plan_proto_rawDesc = "" +
	"\n" +
	"\x1bsaas/api/plan/v1/plan.proto\x12\x10saas.api.plan.v1\x1a\x1cgoogle/api/annotations.proto\x1a google/protobuf/field_mask.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x17validate/validate.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\x1a\x0fblob/blob.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x15query/operation.proto\x1a\x0fdata/data.proto\x1a product/api/price/v1/price.proto\x1a.payment/api/subscription/v1/subscription.proto\"\xb1\x01\n" +
	"\x11CreatePlanRequest\x12\x1d\n" +
	"\x03key\x18\x01 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x03key\x12.\n" +
	"\fdisplay_name\x18\x02 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\vdisplayName\x129\n" +
	"\x06prices\x18\x03 \x03(\v2!.product.api.price.v1.PriceParamsR\x06prices\x12\x12\n" +
	"\x04sort\x18\n" +
	" \x01(\x05R\x04sort\"\x90\x01\n" +
	"\x11UpdatePlanRequest\x12>\n" +
	"\x04plan\x18\x01 \x01(\v2\x1c.saas.api.plan.v1.UpdatePlanB\f\xe2A\x01\x02\xfaB\x05\x8a\x01\x02\x10\x01R\x04plan\x12;\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\"\xc2\x01\n" +
	"\n" +
	"UpdatePlan\x12\x1d\n" +
	"\x03key\x18\x01 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x03key\x12.\n" +
	"\fdisplay_name\x18\x02 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\vdisplayName\x12\x16\n" +
	...
	"\x03key\x18\x01 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x03key\"\xd2\x01\n" +
	"\n" +
	"PlanFilter\x128\n" +
	...
	"filterSize\x12,\n" +
	"\x05items\x18\x03 \x03(\v2\x16.saas.api.plan.v1.PlanR\x05items\"\xf3\x02\n" +
	"\x04Plan\x12\x1d\n" +
	"\x03key\x18\x01 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x03key\x12.\n" +
	"\fdisplay_name\x18\x02 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\vdisplayName\x12\x16\n" +
