...
const file_saas_api_plan_v1_error_reason_proto_rawDesc = "" +
	"\n" +
	"#saas/api/plan/v1/error_reason.proto\x12\x10saas.api.plan.v1\x1a\x13errors/errors.proto*1\n" +
	"\vErrorReason\x12\x1c\n" +
	"\x12DUPLICATE_PLAN_KEY\x10\x00\x1a\x04\xa8E\x90\x03\x1a\x04\xa0E\xf4\x03B,Z*github.com/go-saas/kit/saas/api/plan/v1;v1b\x06proto3"

var (
	file_saas_api_plan_v1_error_reason_proto_rawDescOnce sync.Once
	file_saas_api_plan_v1_error_reason_proto_rawDescData []byte
)
...
func file_saas_api_plan_v1_error_reason_proto_rawDescGZIP() []byte {
	file_saas_api_plan_v1_error_reason_proto_rawDescOnce.Do(func() {
		file_saas_api_plan_v1_error_reason_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_saas_api_plan_v1_error_reason_proto_rawDesc), len(file_saas_api_plan_v1_error_reason_proto_rawDesc)))
	})
...
func file_saas_api_plan_v1_error_reason_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_saas_api_plan_v1_error_reason_proto_rawDesc), len(file_saas_api_plan_v1_error_reason_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
