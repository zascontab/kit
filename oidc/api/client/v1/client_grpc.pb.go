...
type ClientServiceClient interface {
	...
	DeleteOAuth2Client(ctx context.Context, in *DeleteOAuth2ClientRequest, opts ...grpc.CallOption) (*OAuth2Client, error)
...
func (c *clientServiceClient) DeleteOAuth2Client(ctx context.Context, in *DeleteOAuth2ClientRequest, opts ...grpc.CallOption) (*OAuth2Client, error) {
	out := new(OAuth2Client)
...
type ClientServiceServer interface {
	...
	DeleteOAuth2Client(context.Context, *DeleteOAuth2ClientRequest) (*OAuth2Client, error)
...
func (UnimplementedClientServiceServer) DeleteOAuth2Client(context.Context, *DeleteOAuth2ClientRequest) (*OAuth2Client, error) {
