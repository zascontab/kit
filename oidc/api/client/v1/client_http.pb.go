...
type ClientServiceHTTPClient interface {
	...
	DeleteOAuth2Client(ctx context.Context, req *DeleteOAuth2ClientRequest, opts ...http.CallOption) (rsp *OAuth2Client, err error)
...
func (c *ClientServiceHTTPClientImpl) DeleteOAuth2Client(ctx context.Context, in *DeleteOAuth2ClientRequest, opts ...http.CallOption) (*OAuth2Client, error) {
	var out OAuth2Client
