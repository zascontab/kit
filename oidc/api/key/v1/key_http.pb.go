...
type KeyServiceHTTPClient interface {
	...
	DeleteJsonWebKey(ctx context.Context, req *DeleteJsonWebKeyRequest, opts ...http.CallOption) (rsp *JsonWebKeySet, err error)
	DeleteJsonWebKeySet(ctx context.Context, req *DeleteJsonWebKeySetRequest, opts ...http.CallOption) (rsp *JsonWebKeySet, err error)
...
func (c *KeyServiceHTTPClientImpl) DeleteJsonWebKey(ctx context.Context, in *DeleteJsonWebKeyRequest, opts ...http.CallOption) (*JsonWebKeySet, error) {
	var out JsonWebKeySet
...
func (c *KeyServiceHTTPClientImpl) DeleteJsonWebKeySet(ctx context.Context, in *DeleteJsonWebKeySetRequest, opts ...http.CallOption) (*JsonWebKeySet, error) {
	var out JsonWebKeySet
	pattern := "/v1/oidc/keys/{set}"
	path := binding.EncodeURL(pattern, in, true)
