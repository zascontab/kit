...
const file_oidc_api_key_v1_key_proto_rawDesc = "" +
	"\n" +
	"\x19oidc/api/key/v1/key.proto\x12\foidc.api.key\x1a\x13errors/errors.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x17validate/validate.proto\x1a\x1fgoogle/api/field_behavior.proto\";\n" +
	"\x1aDeleteJsonWebKeySetRequest\x12\x1d\n" +
	"\x03set\x18\x01 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x03set\"8\n" +
	"\x17GetJsonWebKeySetRequest\x12\x1d\n" +
	"\x03set\x18\x01 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x03set\"l\n" +
	"\x1aUpdateJsonWebKeySetRequest\x12\x1d\n" +
	"\x03set\x18\x01 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x03set\x12/\n" +
	"\x04keys\x18\x02 \x01(\v2\x1b.oidc.api.key.JsonWebKeySetR\x04keys\"|\n" +
	"\x1aCreateJsonWebKeySetRequest\x12\x1d\n" +
	"\x03set\x18\x01 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x03set\x12?\n" +
	"\x04keys\x18\x02 \x01(\v2+.oidc.api.key.JsonWebKeySetGeneratorRequestR\x04keys\"|\n" +
	"\x1dJsonWebKeySetGeneratorRequest\x12\x1d\n" +
	"\x03alg\x18\x01 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x03alg\x12\x1d\n" +
	"\x03kid\x18\b \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x03kid\x12\x1d\n" +
	"\x03use\x18\x0e \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x03use\"W\n" +
	"\x17DeleteJsonWebKeyRequest\x12\x1d\n" +
	"\x03set\x18\x01 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x03set\x12\x1d\n" +
	"\x03kid\x18\x02 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x03kid\"T\n" +
	"\x14GetJsonWebKeyRequest\x12\x1d\n" +
	"\x03set\x18\x01 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x03set\x12\x1d\n" +
	"\x03kid\x18\x02 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x03kid\"\x83\x01\n" +
	"\x17UpdateJsonWebKeyRequest\x12\x1d\n" +
	"\x03set\x18\x01 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x03set\x12\x1d\n" +
	"\x03kid\x18\x02 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x03kid\x12*\n" +
	"\x03key\x18\x03 \x01(\v2\x18.oidc.api.key.JsonWebKeyR\x03key\"\xd5\x03\n" +
	"\n" +
	"JsonWebKey\x12\x1d\n" +
	"\x03alg\x18\x01 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x03alg\x12\x15\n" +
	...
	"\x01k\x18\a \x01(\tH\x05R\x01k\x88\x01\x01\x12\x1d\n" +
	"\x03kid\x18\b \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x03kid\x12\x1d\n" +
	"\x03kty\x18\t \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x03kty\x12\x11\n" +
	"\x01n\x18\n" +
	...
	"\x02qi\x18\r \x01(\tH\tR\x02qi\x88\x01\x01\x12\x1d\n" +
	"\x03use\x18\x0e \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x03use\x12\x11\n" +
	"\x01x\x18\x0f \x01(\tH\n" +
