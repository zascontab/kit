...
func (c *keyServiceClientProxy) DeleteJsonWebKeySet(ctx context.Context, in *DeleteJsonWebKeySetRequest) (*JsonWebKeySet, error) {
...
func (c *keyServiceClientProxy) DeleteJsonWebKey(ctx context.Context, in *DeleteJsonWebKeyRequest) (*JsonWebKeySet, error) {
