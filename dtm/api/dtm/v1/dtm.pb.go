...
const file_dtm_api_dtm_v1_dtm_proto_rawDesc = "" +
	"\n" +
	"\x18dtm/api/dtm/v1/dtm.proto\x12\x0edtm.api.dtm.v1\x1a\x13errors/errors.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1cgoogle/api/annotations.proto\"0\n" +
	"\x14QueryPreparedRequest\x12\x18\n" +
	"\aservice\x18\x01 \x01(\tR\aservice2\x85\x01\n" +
	"\n" +
	"MsgService\x12w\n" +
	"\rQueryPrepared\x12$.dtm.api.dtm.v1.QueryPreparedRequest\x1a\x16.google.protobuf.Empty\"(\x82\xd3\xe4\x93\x02\"\x12 /v1/{service}/dtm/query-preparedB*Z(github.com/go-saas/kit/dtm/api/dtm/v1;v1b\x06proto3"

var (
	file_dtm_api_dtm_v1_dtm_proto_rawDescOnce sync.Once
	file_dtm_api_dtm_v1_dtm_proto_rawDescData []byte
)

func file_dtm_api_dtm_v1_dtm_proto_rawDescGZIP() []byte {
	file_dtm_api_dtm_v1_dtm_proto_rawDescOnce.Do(func() {
		file_dtm_api_dtm_v1_dtm_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dtm_api_dtm_v1_dtm_proto_rawDesc), len(file_dtm_api_dtm_v1_dtm_proto_rawDesc)))
	})
	return file_dtm_api_dtm_v1_dtm_proto_rawDescData
}

var file_dtm_api_dtm_v1_dtm_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_dtm_api_dtm_v1_dtm_proto_goTypes = []any{
...
func file_dtm_api_dtm_v1_dtm_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dtm_api_dtm_v1_dtm_proto_rawDesc), len(file_dtm_api_dtm_v1_dtm_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   1,
