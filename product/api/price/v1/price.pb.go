...
const file_product_api_price_v1_price_proto_rawDesc = "" +
	...
	"\x05up_to\x18\x03 \x01(\x03R\x04upTo\"\xca\x02\n" +
	"\x0ePriceRecurring\x12=\n" +
	"\binterval\x18\x01 \x01(\tB!\xe2A\x01\x02\xfaB\x1ar\x18R\x03dayR\x04weekR\x05monthR\x04yearR\binterval\x12.\n" +
	...
	"\x05up_to\x18\x03 \x01(\x03B\a\xfaB\x04\"\x02 \x00R\x04upTo\"`\n" +
	"\x16PriceTransformQuantity\x12\x1b\n" +
	"\tdivide_by\x18\x01 \x01(\x03R\bdivideBy\x12)\n" +
	"\x05round\x18\x02 \x01(\tB\x13\xe2A\x01\x02\xfaB\fr\n" +
	"R\x02upR\x04downR\x05round\"\x9f\x06\n" +
	...
	"\x19discounted_amount_decimal\x18e \x01(\tH\x00R\x17discountedAmountDecimal\x88\x01\x01\x12#\n" +
	"\rdiscount_text\x18f \x01(\tR\fdiscountText\x12.\n" +
	"\x13deny_more_discounts\x18g \x01(\bR\x11denyMoreDiscounts\x12B\n" +
	"\x0ebilling_scheme\x18h \x01(\tB\x1b\xe2A\x01\x02\xfaB\x14r\x12R\bper_unitR\x06tieredR\rbillingScheme\x12[\n" +
	...
	"\x12transform_quantity\x18\xb7\x02 \x01(\v2,.product.api.price.v1.PriceTransformQuantityR\x11transformQuantity\x123\n" +
	"\x04type\x18\xb8\x02 \x01(\tB\x1e\xe2A\x01\x02\xfaB\x17r\x15R\bone_timeR\trecurringR\x04typeB\x1c\n" +
	"\x1a_discounted_amount_decimal\"\x98\x01\n" +
	"\x12UpdatePriceRequest\x12E\n" +
	"\x05price\x18\x02 \x01(\v2!.product.api.price.v1.PriceParamsB\f\xe2A\x01\x02\xfaB\x05\x8a\x01\x02\x10\x01R\x05price\x12;\n" +
