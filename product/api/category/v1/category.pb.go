...
const file_product_api_category_v1_category_proto_rawDesc = "" +
	"\n" +
	"&product/api/category/v1/category.proto\x12\x17product.api.category.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1cgoogle/api/annotations.proto\x1a google/protobuf/field_mask.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x17validate/validate.proto\x1a\x15query/operation.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\"i\n" +
	"\x1cCreateProductCategoryRequest\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x1f\n" +
	"\x04name\x18\x02 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x04name\x12\x16\n" +
	"\x06parent\x18\x03 \x01(\tR\x06parent\"\xb5\x01\n" +
	"\x1cUpdateProductCategoryRequest\x12X\n" +
	"\bcategory\x18\x01 \x01(\v2..product.api.category.v1.UpdateProductCategoryB\f\xe2A\x01\x02\xfaB\x05\x8a\x01\x02\x10\x01R\bcategory\x12;\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\"J\n" +
	"\x15UpdateProductCategory\x12\x1d\n" +
	"\x03key\x18\x01 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x03key\x12\x12\n" +
	...
	"\x19GetProductCategoryRequest\x12\x1d\n" +
	"\x03key\x18\x01 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x03key\"\xcd\x01\n" +
