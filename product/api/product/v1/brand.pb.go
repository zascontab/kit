...
const file_product_api_product_v1_brand_proto_rawDesc = "" +
	"\n" +
	"\"product/api/product/v1/brand.proto\x12\x16product.api.product.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1cgoogle/api/annotations.proto\x1a google/protobuf/field_mask.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x17validate/validate.proto\x1a\x15query/operation.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\"\x83\x01\n" +
	"\x12CreateBrandRequest\x12\x1f\n" +
	"\x04code\x18\x02 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x04code\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12\x12\n" +
	"\x04logo\x18\x04 \x01(\tR\x04logo\x12\x10\n" +
	"\x03url\x18\x06 \x01(\tR\x03url\x12\x12\n" +
	"\x04desc\x18\a \x01(\tR\x04desc\"\x9a\x01\n" +
	"\x12UpdateBrandRequest\x12G\n" +
	"\x05brand\x18\x01 \x01(\v2#.product.api.product.v1.UpdateBrandB\f\xe2A\x01\x02\xfaB\x05\x8a\x01\x02\x10\x01R\x05brand\x12;\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\"\x8c\x01\n" +
	"\vUpdateBrand\x12\x1b\n" +
	...
	"\x0fGetBrandRequest\x12\x1b\n" +
	"\x02id\x18\x01 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x02id\"\x81\x01\n" +
	"\vBrandFilter\x126\n" +
