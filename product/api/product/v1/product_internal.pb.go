...
const file_product_api_product_v1_product_internal_proto_rawDesc = "" +
	...
	"\t_brand_id\"\xaa\x01\n" +
	"\x1cUpdateInternalProductRequest\x12M\n" +
	"\aproduct\x18\x01 \x01(\v2%.product.api.product.v1.UpdateProductB\f\xe2A\x01\x02\xfaB\x05\x8a\x01\x02\x10\x01R\aproduct\x12;\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\"8\n" +
	"\x19GetInternalProductRequest\x12\x1b\n" +
	"\x02id\x18\x01 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x02id\".\n" +
	"\x1cDeleteInternalProductRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\",\n" +
	"\x1aDeleteInternalProductReply\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\"6\n" +
	"\x17GetInternalPriceRequest\x12\x1b\n" +
	"\x02id\x18\x01 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x02id2\xc1\x05\n" +
