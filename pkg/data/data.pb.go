...
func (x *DynamicValue) Reset() {
	*x = DynamicValue{}
	mi := &file_pkg_data_data_proto_msgTypes[0]
...
func (*DynamicValue) Descriptor() ([]byte, []int) {
	return file_pkg_data_data_proto_rawDescGZIP(), []int{0}
}
...
func (x *DynamicValueFilter) Reset() {
	*x = DynamicValueFilter{}
	mi := &file_pkg_data_data_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DynamicValueFilter) Descriptor() ([]byte, []int) {
	return file_pkg_data_data_proto_rawDescGZIP(), []int{1}
}
...
var File_pkg_data_data_proto protoreflect.FileDescriptor

const file_pkg_data_data_proto_rawDesc = "" +
	"\n" +
	"\x13pkg/data/data.proto\x12\x04data\x1a\x1cgoogle/protobuf/struct.proto\x1a\x15query/operation.proto\"\xdc\x02\n" +
...
var (
	file_pkg_data_data_proto_rawDescOnce sync.Once
	file_pkg_data_data_proto_rawDescData []byte
)

func file_pkg_data_data_proto_rawDescGZIP() []byte {
	file_pkg_data_data_proto_rawDescOnce.Do(func() {
		file_pkg_data_data_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_data_data_proto_rawDesc), len(file_pkg_data_data_proto_rawDesc)))
	})
	return file_pkg_data_data_proto_rawDescData
}

var file_pkg_data_data_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_pkg_data_data_proto_goTypes = []any{
...
var file_pkg_data_data_proto_depIdxs = []int32{
...
func init() { file_pkg_data_data_proto_init() }
func file_pkg_data_data_proto_init() {
	if File_pkg_data_data_proto != nil {
		return
	}
	file_pkg_data_data_proto_msgTypes[0].OneofWrappers = []any{
	...
	file_pkg_data_data_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_data_data_proto_rawDesc), len(file_pkg_data_data_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_data_data_proto_goTypes,
		DependencyIndexes: file_pkg_data_data_proto_depIdxs,
		MessageInfos:      file_pkg_data_data_proto_msgTypes,
	}.Build()
	File_pkg_data_data_proto = out.File
	file_pkg_data_data_proto_goTypes = nil
	file_pkg_data_data_proto_depIdxs = nil
}
