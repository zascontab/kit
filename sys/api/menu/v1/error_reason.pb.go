...
const file_sys_api_menu_v1_error_reason_proto_rawDesc = "" +
	"\n" +
	"\"sys/api/menu/v1/error_reason.proto\x12\x0fsys.api.menu.v1\x1a\x13errors/errors.proto*L\n" +
	"\vErrorReason\x12\x1d\n" +
	"\x13MENU_NAME_DUPLICATE\x10\x00\x1a\x04\xa8E\x90\x03\x12\x18\n" +
	"\x0eMENU_PRESERVED\x10\x01\x1a\x04\xa8E\x93\x03\x1a\x04\xa0E\xf4\x03B+Z)github.com/go-saas/kit/sys/api/menu/v1;v1b\x06proto3"

var (
	file_sys_api_menu_v1_error_reason_proto_rawDescOnce sync.Once
	file_sys_api_menu_v1_error_reason_proto_rawDescData []byte
)

func file_sys_api_menu_v1_error_reason_proto_rawDescGZIP() []byte {
	file_sys_api_menu_v1_error_reason_proto_rawDescOnce.Do(func() {
		file_sys_api_menu_v1_error_reason_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_sys_api_menu_v1_error_reason_proto_rawDesc), len(file_sys_api_menu_v1_error_reason_proto_rawDesc)))
	})
...
var file_sys_api_menu_v1_error_reason_proto_goTypes = []any{
...
func file_sys_api_menu_v1_error_reason_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_sys_api_menu_v1_error_reason_proto_rawDesc), len(file_sys_api_menu_v1_error_reason_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
